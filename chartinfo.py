...
class chartinfo:
    ...
    # 밑에 한번 확인해 주세요
    list_color = ["black", "orange", "green", "navy", "yellow", "gray", "aqua", "purple", "coral", "olive", "deepskyblue", "crimson", "chocolate", "teal", "hotpink"]
    dict_process = {}
    num_of_process = 0
    max_end_time = 0
    ...
    def __init__(self, start_time, end_time, last_time, process):
        ...
        chartinfo.min_start_time = min(chartinfo.min_start_time, start_time)
    ...
    def __set_color(self):
        ...
        self.__color = chartinfo.list_color[chartinfo.num_of_process]
    ...
    def reset(cls):
        ...
        cls.max_end_time = 0
        cls.min_start_time = sys.maxsize